    ...
    with OperationTestConfig.module_name("conv"):
        return [
            ...
            OperationTestConfig(
                ...
                numpy.random.normal(size=(2, 16, 16, 3)).astype(numpy.float32),
                numpy.random.normal(size=(5, 5, 3, 8)).astype(numpy.float32),
            ...
            OperationTestConfig(
                ...
                numpy.random.normal(size=(2, 32, 3)).astype(numpy.float32),
                numpy.random.normal(size=(3, 3, 4)).astype(numpy.float32),
